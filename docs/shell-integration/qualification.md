...
| `plugin_active` | the shell's own answer to "is this customisation loaded and working" |
| `plugin_writes_buffer` | the customisation putting text in the reader's buffer that nobody typed, and the line then running |
