...
protected list whose every grant names one of those two or an account that already holds the
machine. A pipe that fails the check gets nothing, and the shell starts without integration.
