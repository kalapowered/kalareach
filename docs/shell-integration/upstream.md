...
| psreadline | PSReadLine | psreadline-2.3.4 to 3.0.0 on PowerShell 7.4 or later | https://github.com/PowerShell/PowerShell | qualified rather than fetched | the PSReadLine and PowerShell repositories' security advisories and the PowerShell release notes |
<!-- /kr:pins -->
...
| 2026-09-20 | The PSReadLine and PowerShell advisories published against the qualified range | psreadline | The qualified range is PSReadLine 2.3.4 up to 3.0 on PowerShell 7.4 or later, and the machine this qualification ran on carried 2.4.5 on 7.6.6. Nothing in the range is unqualified. | 2026-10-04 | not-affected |
<!-- /kr:triage -->
