...
use crate::catalogue::{
    CatalogueAddParams, CatalogueAddResult, CatalogueBudgets, CatalogueDelegation,
    ...
    CatalogueSyncResult, PluginCapabilitiesParams, PluginCapabilitiesResult,
    PluginCapabilityEvidence, PluginCapabilityGrant, PluginEnableParams, PluginEnableResult,
    PluginGrantParams, PluginGrantResult, PluginInstallParams, PluginInstallResult,
    PluginListParams, PluginListResult, PluginPinParams, PluginPinResult, PluginRemoveParams,
    PluginRemoveResult, PluginSummary,
};
use crate::changeset::{
...
use crate::project::{
    ...
    ProjectListParams, ProjectListResult, ProjectLocationAttachParams, ProjectLocationAttachResult,
    ProjectLocationAuthoriseParams, ProjectLocationAuthoriseResult, ProjectLocationListParams,
    ProjectLocationListResult, ProjectLocationWithdrawParams, ProjectLocationWithdrawResult,
...
pub fn protocol_schema() -> Value {
    ...
    roots! {
        ...
        "catalogue_budgets" => CatalogueBudgets,
