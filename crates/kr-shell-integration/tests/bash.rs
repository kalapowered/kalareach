...
#[test]
#[ignore = "drives this tree's built Bash package; it runs with --include-ignored where the packages are built, as continuous integration's shell-packages job does"]
