...
//!
//! A run with no qualified package prints why and stops; continuous integration publishes the
//! qualification in the same job and sets `KR_REQUIRE_SHELL_PACKAGES`, where an absent package is
//! a failure.
//!
